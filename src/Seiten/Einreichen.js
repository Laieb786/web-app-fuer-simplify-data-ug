...
import IdeaFeedback from '../Komponenten/EinreichenComponent';
import IdeenBild from '../Grafiken/Ideen.png';
...
const Einreichen = () => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', my: 25, marginBottom: 10}}>
        <IdeaFeedback onIdeaSubmit={handleIdeaSubmit} />
        <img src={IdeenBild} alt="Ideen Bild" style={{ width: '400px', marginLeft: '40px' }} />
      </Box>
    </Container>
  );
};

export default Einreichen;
